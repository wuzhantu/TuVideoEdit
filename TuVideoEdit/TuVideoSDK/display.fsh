...
//        vec2 vpos = vTextureCoord;
//        if (vpos.x > 0.75) {
//            vpos.x = 1.5 - vpos.x; // 如果是 1.0 - vpos.x 就是青色
//        }
//        float y = texture(yuvTexture, ypos).r;
//        float u = texture(yuvTexture, upos).r - 0.5;
//        float v = texture(yuvTexture, vpos).r - 0.5;
...
//
//        if (ypos.y <= 2.0/3.0) {
//            ypos.y *= 1.0/3.0 + (ypos.y - 1.0/3.0) * 2.0;
//        } else {
//            ypos.y = 1.0/3.0 + (ypos.y - 2.0/3.0) * 2.0;
//        }
//
//        vec2 upos = uTextureCoord;
//        if (upos.x <= 0.25) {
...
//            upos.y *= 2.0;
//        } else {
//            upos.y = (upos.y - 1.0/6.0) * 2.0;
//        }
//
//        vec2 vpos = vTextureCoord;
//        if (vpos.x <= 0.75) {
//            vpos.x *= 0.5 + (vpos.x - 0.5) * 2.0;
//        } else {
//            vpos.x = 0.5 + (vpos.x - 0.75) * 2.0;
//        }
//
//        if (vpos.y <= 1.0/6.0) {
//            vpos.y *= 2.0;
//        } else {
//            vpos.y = (vpos.y - 1.0/6.0) * 2.0;
//        }
//
//        float y = texture(yuvTexture, ypos).r;
//        float u = texture(yuvTexture, upos).r - 0.5;
